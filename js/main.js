...
function initializeDOMAndEvents(controllers, services) {
    ...
    const domElements = {
        ...
        playerNoteInput: document.getElementById('player-note'),
        uploadRankingBtn: document.getElementById('upload-ranking-btn'),
    ...
    controllers.timerController.initDOM({
        ...
        rankingForm: domElements.rankingForm,
        playerNoteInput: domElements.playerNoteInput,
        uploadRankingBtn: domElements.uploadRankingBtn,
        viewRankingBtn: domElements.viewRankingBtn
    });
